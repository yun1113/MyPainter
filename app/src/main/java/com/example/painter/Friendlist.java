...
import friendlist.DataItem;
import friendlist.DataSource;

public class Friendlist extends ActionBarActivity implements AdapterView.OnItemClickListener {
    ...
    private class SampleAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ViewHolder holder;
            if (convertView == null) {
                convertView = View.inflate(Friendlist.this, R.layout.friendlist_item, null);
